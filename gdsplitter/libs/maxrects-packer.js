...
window.MaxRectsPacker = require("./node_modules/maxrects-packer");
},{"./node_modules/maxrects-packer":2}],2:[function(require,module,exports){
        ...
        findNode(width, height, allowRotation) {
            ...
            for (let i in this.freeRects) {
                ...
                if (r.width >= width && r.height >= height) {
                    areaFit = (this.options.logic === exports.PACKING_LOGIC.MAX_AREA) ?
